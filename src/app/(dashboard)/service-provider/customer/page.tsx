...
export default function BookingsPage() {
  ...
  const filteredCustomers = customers.filter((cust) => {
    ...
    const isNotAlreadyAdded = !startups.some(
      (startup) => startup._id === cust._id,
    );
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-1">
                  Manage your startup partnerships
                </p>
              </div>
            </div>
            ...
            <Table className="w-full">
              <TableHeader className="bg-slate-50/80">
                <TableRow className="border-b border-slate-200/60">
                  ...
                  <TableHead className="py-4 px-6 font-semibold text-slate-700 text-center">
                    Actions
                  </TableHead>
                </TableRow>
              </TableHeader>
                  ...
                  <Table className="w-full">
                    <TableHeader className="bg-white/80 sticky top-0">
                      <TableRow className="border-b border-slate-200">
                        ...
                        <TableHead className="px-6 py-4 font-semibold text-slate-700 text-center">
                          Action
                        </TableHead>
                      </TableRow>
                    </TableHeader>
