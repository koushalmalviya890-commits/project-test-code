        ...
        <div className="border rounded-lg overflow-hidden">
          <div className="bg-amber-50 border-b border-amber-200 p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  You need to complete your Facility Partner profile before you
                  can add facilities. This ensures that startups have all the
                  necessary information about your services.
                </p>
                    ...
                    <div className="space-y-2">
                      ...
                      <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-5">
                        ...
                        {incompleteFields.length > 5 && (
                          <li>
                            And {incompleteFields.length - 5} more fields...
                          </li>
                        )}
                      </ul>
                    </div>
          ...
          <div className="p-6 bg-gray-50">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              A complete profile helps startups make informed decisions about
              your facilities. It builds trust and increases the likelihood of
              bookings.
            </p>
            ...
            <p className="text-sm text-muted-foreground">
              Once your profile is complete, you'll be able to add facilities,
              manage bookings, and start receiving requests from startups.
            </p>
          </div>
        </div>
      </div>
          ...
          {selectedType && profile?.data && (
            <>
              <div className="text-sm text-muted-foreground mb-4">
                <p>
                  Address fields are pre-filled with your service provider
                  profile information. You can modify them if needed.
                </p>
              </div>
              <FacilityForm
                type={selectedType}
