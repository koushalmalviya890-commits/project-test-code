...
<div>
              <div>
            <Label className="text-base font-semibold text-gray-900 mb-4 block">
              Apply GST<span className="text-red-500">*</span>
            </Label>
            <RadioGroup
              value={formData.applyGst}
              onValueChange={(value: "yes" | "no") =>
                updateField("applyGst", value)
              }
              className="flex gap-8"
            >
              <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <Label className="text-base font-semibold text-gray-900 mb-4 mt-4 block">
                Platform fee 2% Deducted from<span className="text-red-500">*</span>
            </Label>
            <RadioGroup
              value={formData.applyPlatformFee}
              onValueChange={(value: "yes" | "no") =>
                updateField("applyPlatformFee", value)
              }
              className="flex gap-8"
            >
              <div className="flex items-center space-x-2">
          ...
          {formData.ticketType === "paid" && (
            <div>
              ...
              >
                Tickets Price<span className="text-red-500">*</span>
              </Label>
              <div className="relative">
