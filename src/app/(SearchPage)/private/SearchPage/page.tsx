...
function SearchPageClient() {
  ...
  const fetchFacilities = async () => {
    try {
      ...
      if (id) {
       // console.log(id, 'id in search page client')
  ...
  useEffect(() => {
    ...
    } else if (filters.propertyTypes.length > 0 && filters.propertyTypes[0] !== 'All') {
      // If no property types in URL but we have non-All property types, reset to All
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <Dialog open={isFilterOpen} onOpenChange={handleFilterClose}>
        <DialogContent className="sm:max-w-[500px] p-0 hide-scrollbar max-h-[90vh] smart-scrollbar">
