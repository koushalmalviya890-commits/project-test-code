...
export default function TestimonialsCarousel() {
  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col items-center justify-center py-8 sm:pb-12 md:pb-16 px-4">
      <div className="relative w-full max-w-[1400px] mx-auto">
        {/* Header */}
        {/* <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 px-4">
            <span className="text-gray-900">Still </span>
            <span className="text-green-500">don't believe </span>
            <span className="text-gray-900">our word for it!</span>
          </h2>
          <p className="text-gray-500 text-base sm:text-lg md:text-xl">See the feedback from your team</p>
        </div> */}
