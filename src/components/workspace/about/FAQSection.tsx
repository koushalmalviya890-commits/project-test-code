...
const faqData = {
  ...
  startup: [
    {
      question: "What workspaces are available?",
      answer:
        "Co-working desks, private cabins, meeting rooms, and event spaces on demand.",
    },
    {
      question: "How does booking work?",
      answer:
        "Booking is handled via our streamlined online system with transparent UFI pricing. Check real-time availability and book instantly.",
    },
    {
      question: "How do I get started?",
      answer:
        "Simply browse available workspaces, select your preferred location and time, and complete your booking in minutes.",
    },
    {
      question: "Why choose this platform?",
      answer:
        "Cumma offers flexible workspaces with transparent pricing, quick booking flows, and analytics to help optimize your workspace spending.",
    },
  ],
};

// ✅ FAQ Section Component
export default function WorkspaceFAQSection({ mode }: FAQSectionProps) {
