...
import { RENTAL_PLANS, AMENITIES, RawSpaceLabFields, FacilityFormProps } from '../types/index'
...
const formSchema = z.object({
  ...
  areaDetails: z.array(z.object({
    area: z.number().min(1, 'Area is required').optional().or(z.undefined()),
