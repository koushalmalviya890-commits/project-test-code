...
export function MeetingRoomsForm({
  onSubmit,
  onChange,
  initialData,
}: FacilityFormProps) {
 ...
 // console.log("INitial",initialData);
  ...
  const toggleSector = (sector: string) => {
    ...
    form.setValue("relevantSectors", updated);
  };
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      totalTrainingRoomSeaters: initialData?.totalTrainingRoomSeaters || 0,
      rentPerYear:
  ...
  const handleFormSubmit = async (values: FormValues) => {
    try {
     ...
     // console.log("Form values:", values);
      ...
      if (!rentValidation) {
       // console.log(
        //   "Validation failed: Missing rent values for selected plans"
        // );
        form.setError("root", {
          type: "manual",
...
/>
          ...
          <FormField
            ...
            render={() => (
              <FormItem>
                <FormLabel>
                  Kindly upload the photos of your Meeting/Board Rooms *
                </FormLabel>
                <FormControl>
                  <ImageUpload
                    value={images}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* @ts-ignore - Suppressing TypeScript error for 'Hourly' rental plan */}
