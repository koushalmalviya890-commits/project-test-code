...
const formSchema = z.object(
  {
    ...
    selectedRentalPlans: z.array(rentalPlanSchema).optional(),
...
export function PrototypingLabsForm({ onSubmit, onChange, initialData }: FacilityFormProps) {
 // console.log('PrototypingLabsForm initialData:', initialData);
 // console.log('PrototypingLabsForm address fields:', {
