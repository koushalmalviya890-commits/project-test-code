...
import { RENTAL_PLANS, AMENITIES, SoftwareFields, FacilityFormProps } from '../types/index'
        ...
        <div className="space-y-4">
          ...
          <FormControl>
            <ImageUpload
              ...
              onRemove={(url) => {
                const newImages = images.filter((val) => val !== url);
                setImages(newImages);
                form.setValue('images', newImages);
                onChange?.();
              }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {selectedRentalPlans.includes('Annual') && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Yearly Rent (in Rupees) *</FormLabel>
                  <FormControl>
                    <Input 
                      type="number" 
                      min={0}
          ...
          {selectedRentalPlans.includes('One Day (24 Hours)') && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Day Pass Rent (in Rupees) *</FormLabel>
                  <FormControl>
                    <Input 
                      type="number" 
                      min={0}
