...
const FeaturesSection = () => {
  const features = [
    {
      ...
      description: "Book advanced equipment when you need it, without ownership costs."
    },
    {
      icon: <List />,
      title: "Wide Variety",
      description: "From manufacturing to engineering and research facilities, all in one place."
    },
    {
      icon: <Wallet />,
      title: "Cost-Efficient",
      description: "Pay only for hours, days, or months you actually use."
    },
    {
      icon: <BarChart3 />,
      title: "Transparent Tracking",
      description: "Get clear booking history, usage reports, and spending insights."
    },
    {
      icon: <Users />,
      title: "Collaborative Ecosystem",
      description: "Connect with institutions, incubators, and industry experts."
    },
    {
      icon: <Search />,
      title: "Seamless Experience",
      description: "Quick search, instant booking, zero hassle."
    }
  ];
  ...
  return (
    <section className="relative w-full pb-20 md:pb-0 mb-30 px-4 md:px-8 md:mb-10 overflow-hidden h-[980px] md:h-[760px]">
      ...
      {/* Positioned absolutely to the bottom right, behind content if needed, or overlapping */}
      <div className="hidden md:block absolute -bottom-10 -right-10 md:bottom-[5px] md:right-0 w-[300px] h-[300px] md:w-[500px] md:h-[380px] pointer-events-none z-10 opacity-90">
