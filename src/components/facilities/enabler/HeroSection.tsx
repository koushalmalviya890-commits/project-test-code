  ...
  return (
    <section className="w-full bg-white pt-28 md:pt-10 pb-16 px-4 md:px-8 flex flex-col items-center text-center font-sans">
      ...
      <div className="w-full max-w-7xl flex justify-start mb-10 text-sm text-gray-500">
        <span>
          Category &gt;{" "}
          <span className="text-green-600 font-medium">Enabler</span>
        </span>
      </div>
      ...
      {/* Main Headline */}
      <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight max-w-4xl mb-6">
        <span className="text-green-500">Supercharge</span> Your Lab with the right
      ...
      <p className="text-gray-500 text-lg md:text-xl max-w-2xl mb-10">
        We connect enablers with startups, researchers, and companies.
      </p>
      <div className="block sm:hidden w-[300px] h-[240px] mr-50 md:mr-0 mb-10 md:mb-0 md:w-[500px] md:h-[380px] pointer-events-none z-10 scale-x-[-1]">
        ...
        <img
          src="/facility/mobilerobotarm.svg"
